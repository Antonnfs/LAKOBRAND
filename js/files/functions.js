...
//========================================================================================================================================================
// Корзина
/*export function cartCloseWindow() {
...
export function menuCatalog() {
	...
	if (buttonMenu) {
		document.addEventListener("click", function (e) {
			...
			let tagretItem = e.target;
			if (!tagretItem.closest(".button-menu")) {
...
menuCatalog()
export function menuCatalogOpen() {
	//bodyLock();
	document.documentElement.classList.add("menu-catalog-open");
}
menuCatalogOpen()
export function menuCatalogClose() {
	//bodyUnlock();
	document.documentElement.classList.remove("menu-catalog-open");
}
menuCatalogClose()
