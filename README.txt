В проекте используется сборщик Gulp с плагином от Webpack.
Собранный production-code сжат и минифицирован. 
Исходный код вы можете посмотреть в ветке development или скачать проект и запустить локально.

Команды терминала для запуска проекта:
...
Основные файлы для работы со сборкой:
js/app.js
scss/style.scss
index.html 
